    ...
    public function run()
    {
        ...
        if (!\DB::table('users')->find(1)) {
            \DB::table('users')->insert([
                0 => [
                    'id'             => 1,
                    'name'           => 'siddikat',
                    'email'          => 'siddikat.martins@icloud.com',
        ...
        \DB::table('chatter_discussion')->insert([
            0 => [
                ...
                'title'               => 'Hallo hier ist meine Einlatung',
                'user_id'             => 1,
                'sticky'              => 0,
                'views'               => 0,
                'answered'            => 0,
            ...
            1 => [
                ...
                'title'               => 'Informationen über Datenbank2',
                'user_id'             => 1,
                'sticky'              => 0,
                'views'               => 0,
                'answered'            => 0,
            ...
            2 => [
                ...
                'title'               => 'Html ist sehr wichtig geworden',
                'user_id'             => 1,
                'sticky'              => 0,
                'views'               => 0,
                'answered'            => 0,
            ...
            4 => [
                'id'                  => 9,
                'chatter_category_id' => 2,
                'title'               => 'Willkommen auf unsere Seite RaumReservierung',
                'user_id'             => 1,
                'sticky'              => 0,
                'views'               => 0,
                'answered'            => 0,
